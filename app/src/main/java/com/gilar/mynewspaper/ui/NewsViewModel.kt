...
import com.gilar.mynewspaper.util.Resources
import com.gilar.mynewspaper.util.TopBarState
import com.gilar.mynewspaper.util.filterResponse
...
class NewsViewModel(private val newsRepository: NewsRepository) : ViewModel() {
    ...
    fun getNewsByCategory(category:String,countryCode: String=currentCountry) = viewModelScope.launch {
        ...
        try {
            val response = newsRepository.getCategoryNews(countryCode, category = category, pageNumber = breakingNewsPage)
